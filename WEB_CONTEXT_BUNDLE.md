...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-3.33-kirby-problem-3.33-deb572b3-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-3.33"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-3.33-kirby-problem-3.33-deb572b3-v1",
      "problem_contract_sha256": "f7e6bf08013c3e46af02541972e058bc88aa1f96b3492b5c6b2f793da342f27f",
      "problem_id": "problem:um-kp-3.33-kirby-problem-3.33-deb572b3",
      "route_id": "route:um-kp-3.33-kirby-problem-3.33-deb572b3-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-3.33-kirby-problem-3.33-deb572b3-source-fidelity-01",
      "graph_id": "graph:um-kp-3.33-kirby-problem-3.33-deb572b3-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-3.33-kirby-problem-3.33-deb572b3-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-3.33-kirby-problem-3.33-deb572b3-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let M and N be closed orientable 3-manifolds. Prove that if there is a degree-1 map $f:M\\to N$ then $g(M)\\geq g(N)$, where $g(M)$ is the Heegaard genus of $M$."
          },
          "statement_sha256": "e8d4c78e8ac247270111989312df3f8a85defbfe2d56fd4c388e28a59ce969f6"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-3.33-kirby-problem-3.33-deb572b3-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-3.33-kirby-problem-3.33-deb572b3-root",
      "route_id": "route:um-kp-3.33-kirby-problem-3.33-deb572b3-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-3.33-19ff3c2d4227",
        "url": "https://www.unsolvedmath.com/problems/KP-3.33"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
